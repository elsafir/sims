...
<body class="bg-gradient-primary">
    ...
    <div class="form-group">
        <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp"
            placeholder="Enter Email Address..." name="email"> <!-- Tambahkan atribut name="email" -->
    </div>
    <div class="form-group">
        <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password"
            name="password"> <!-- Tambahkan atribut name="password" -->
    </div>
    <div class="form-group">
    ...
    <button type="submit" class="btn btn-primary btn-user btn-block">Login</button> <!-- Ganti link dengan button submit -->
    <hr>
